...
public class HW01 {
    public static void main(String[] args) {
        ...
        double avgKor = 0.0, avgMat = 0.0, avgSoi = 0.0, avgSic = 0.0;
        //다차원 배열 만들기
        ...
        avgKor = (double) totalKor / gradeArray[0].length;
        avgMat = (double) totalMat / gradeArray[1].length;
        avgSoi = (double) totalSoi / gradeArray[2].length;
        avgSic = (double) totalSic / gradeArray[3].length;
