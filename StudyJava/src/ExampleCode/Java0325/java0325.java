...
//첫번째 미션
//아래코드가 실행될 수 있도록 Students 클래스르 완성하시오.
//힌트 : 세터메서드를 만들어야 함. toString()은 오버라이딩 필요
public class java0325 {
...
*/
        ...
        //두번째 미션
        //아래 메서드를 완성하시오
        //주어진 배열을 이용하여 Students 타입의 배열을 만들고 for문으로 출력해야함
        createStudentsInfo();
        }
        ...
        public static void createStudentsInfo() {
            ...
            //데이터베이스의 raw data(가공하지 않은 데이터)를
